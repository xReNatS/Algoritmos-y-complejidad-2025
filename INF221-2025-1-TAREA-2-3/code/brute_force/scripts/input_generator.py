...
# Script: Generador de inputs para fuerza bruta con longitudes de n y m acotadas a 20
# Cada archivo input_<k>.txt en ../data/brute_force_input

# Directorio de destino
directorio = os.path.join('..', 'data', 'brute_force_input')
